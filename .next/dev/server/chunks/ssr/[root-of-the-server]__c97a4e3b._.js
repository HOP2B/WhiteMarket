...
;
const Navbar = ()=>{
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
const getGigs = ()=>{
    return new Promise((resolve)=>{
        setTimeout(()=>resolve(__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockGigs"]), 500);
    });
};
const getGigById = (id)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            const gig = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockGigs"].find((gig)=>gig.id === id);
            resolve(gig);
        }, 500);
    });
};
const getUserById = (id)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockUsers"].find((user)=>user.id === id);
            resolve(user);
        }, 500);
    });
};
const getMessages = (userId)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            const userMessages = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockMessages"].filter((msg)=>msg.senderId === userId || msg.receiverId === userId);
...
const sendMessage = (message)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockMessages"].push(message);
            resolve(message);
        }, 500);
    });
};
...
;
const Home = ()=>{
    const { gigs, setGigs } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AppContext$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["useApp"])();
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const fetchGigs = async ()=>{
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$mockApi$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["getGigs"])();
                setGigs(data);
                setLoading(false);
            } catch (error) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                        ...
                        children: filteredGigs.map((gig)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$GigCard$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["default"], {
                                gig: gig
                            }, gig.id, false, {
                                fileName: "[project]/pages/index.tsx",
                                lineNumber: 81,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c97a4e3b._.js.map