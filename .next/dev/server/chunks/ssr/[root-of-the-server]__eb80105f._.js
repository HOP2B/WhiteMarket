...
const getUserById = async (id)=>{
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from("users").select(`
      *,
      user:users!user_id(name, avatar)
    `).eq("id", id).single();
    if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__eb80105f._.js.map