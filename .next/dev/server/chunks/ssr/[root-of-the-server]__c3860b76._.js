...
const Login = ()=>{
    ...
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    const handleSubmit = (e)=>{
        e.preventDefault();
        // Simple authentication - in a real app, use proper auth
        const user = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.email === email);
        if (user) {
            login(user);
            router.push("/");
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c3860b76._.js.map