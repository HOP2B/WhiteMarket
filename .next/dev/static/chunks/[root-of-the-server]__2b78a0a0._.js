...
const AuthProvider = ({ children })=>{
    ...
    const { signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$react$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["useClerk"])();
...
_s(AuthProvider, "CulcM6w/XYrUVInprP5UUVxud9U=", false, function() {
    return [
                        ...
                        children: [
                            ...
                            user ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    user.unsafeMetadata?.role === "worker" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$link$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                                        href: "/offer-service",
                                        className: "text-gray-700 hover:text-green-600 transition-colors duration-200",
    ...
    try {
      ...
      `).order("id");
        if (error || !data || data.length === 0) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockGigs"].map((gig)=>{
        ...
        return data.map((gig)=>({
                ...gig,
                userName: gig.users?.name || "Unknown User",
                userAvatar: gig.users?.avatar || "/default-avatar.jpg",
                userId: gig.user_id
            }));
    } catch (error) {
        // Fallback to mock data
...
const getGigById = async (id)=>{
    try {
      ...
      `).eq("id", id).single();
        if (error || !data) {
            // Fallback to mock data
            const mockGig = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockGigs"].find((gig)=>gig.id === id);
            if (mockGig) {
        ...
        return {
            ...data,
            userName: data.users?.name || "Unknown User",
            userAvatar: data.users?.avatar || "/default-avatar.jpg",
            userId: data.user_id
        };
    } catch (error) {
        // Fallback to mock data
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: conversations.map((conversationId)=>{
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: selectedConversation ? messages.filter((msg)=>msg.senderId === user.id && msg.receiverId === selectedConversation || msg.senderId === selectedConversation && msg.receiverId === user.id).map((message)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Messages, "iwbXjCAQBu+d34j1Lcgcvb/T3yo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b78a0a0._.js.map