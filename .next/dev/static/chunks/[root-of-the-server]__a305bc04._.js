...
"[project]/data/mockData.ts [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/data/mockData.ts [client] (ecmascript)");
;
;
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        if (stored) {
            try {
                ...
                return [
                    ...__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockGigs"],
                    ...parsed
                ];
            } catch (e) {
...
const saveGigsToStorage = (gigs)=>{
    if ("TURBOPACK compile-time truthy", 1) {
        ...
        const newGigs = gigs.filter((gig)=>!__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockGigs"].find((defaultGig)=>defaultGig.id === gig.id));
...
const getGigs = async ()=>{
    // Use persisted mock data for development
    return mockGigsData.map((gig)=>{
        const mockUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockUsers"].find((user)=>user.id === gig.userId);
        return {
            ...gig,
...
const getGigById = async (id)=>{
    // Use persisted mock data for development
    const mockGig = mockGigsData.find((gig)=>gig.id === id);
    if (mockGig) {
        const mockUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockUsers"].find((user)=>user.id === mockGig.userId);
        return {
            ...mockGig,
...
const searchGigs = async (query, filters = {})=>{
    let filteredGigs = mockGigsData.map((gig)=>{
        const mockUser = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockUsers"].find((user)=>user.id === gig.userId);
        return {
            ...gig,
            userName: mockUser?.name || gig.userName,
    ...
    // Text search
    if (query) {
        filteredGigs = filteredGigs.filter((gig)=>gig.title.toLowerCase().includes(query.toLowerCase()) || gig.description.toLowerCase().includes(query.toLowerCase()) || gig.category.toLowerCase().includes(query.toLowerCase()));
    }
    // Category filter
    if (filters.category) {
    ...
    if (filters.sortBy) {
        switch(filters.sortBy){
            ...
            case "rating":
                ...
                break;
            case "newest":
                // Since mock data doesn't have createdAt, sort by ID (newer IDs = newer gigs)
                filteredGigs.sort((a, b)=>parseInt(b.id) - parseInt(a.id));
                break;
            default:
                break;
        }
...
const getCategories = async ()=>{
    const categories = [
        ...new Set(mockGigsData.map((gig)=>gig.category))
    ];
    return categories.map((category)=>({
            name: category,
            count: mockGigsData.filter((gig)=>gig.category === category).length
        }));
};
const getUserStats = async (userId)=>{
    const userGigs = mockGigsData.filter((gig)=>gig.userId === userId);
...
const createGig = async (gigData)=>{
    ...
    mockGigsData.push(newGig);
    saveGigsToStorage(mockGigsData);
    return newGig;
};
const updateGig = async (gigId, updates)=>{
    const gigIndex = mockGigsData.findIndex((gig)=>gig.id === gigId);
    if (gigIndex > -1) {
        mockGigsData[gigIndex] = {
            ...mockGigsData[gigIndex],
            ...updates
        };
        saveGigsToStorage(mockGigsData);
        return mockGigsData[gigIndex];
    }
...
const Messages = ()=>{
    ...
    const handleSendMessage = async ()=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$mockApi$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["sendMessage"])(message);
            setMessages([
                ...messages,
                message
            ]);
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: filteredConversations.map((conversationId)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: `p-4 cursor-pointer hover:bg-gray-50 ${selectedConversation === conversationId ? "bg-gray-100" : ""}`,
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            className: "bg-green-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center ml-2",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "lg:w-3/4 bg-white rounded-lg shadow-md",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-4 border-b",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: selectedConversation ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                            children: [
                                                messages.filter((msg)=>msg.senderId === user.id && msg.receiverId === selectedConversation || msg.senderId === selectedConversation && msg.receiverId === user.id).map((message)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: `mb-4 flex ${message.senderId === user.id ? "justify-end" : "justify-start"}`,
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: `max-w-xs lg:max-w-md rounded-lg p-3 ${message.senderId === user.id ? "bg-green-600 text-white" : "bg-gray-200 text-gray-900"}`,
                                                            children: [
                                                ...
                                                userStatuses[selectedConversation]?.isTyping && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "bg-gray-200 text-gray-900 rounded-lg p-3",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    selectedConversation && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                        className: "cursor-pointer bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 flex items-center",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                className: "mr-1",
                                                                children: "📎"
                                            ...
                                            showEmojiPicker && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "absolute bottom-16 left-4 bg-white border border-gray-300 rounded-lg p-3 shadow-lg",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Messages, "/1snwqH3zpYXegJZytIPfLaz+WU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a305bc04._.js.map