...
const getGigs = ()=>{
    return new Promise((resolve)=>{
        setTimeout(()=>resolve(__TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockGigs"]), 500);
    });
};
const getGigById = (id)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            const gig = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockGigs"].find((gig)=>gig.id === id);
            resolve(gig);
        }, 500);
    });
};
const getUserById = (id)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            const user = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockUsers"].find((user)=>user.id === id);
            resolve(user);
        }, 500);
    });
};
const getMessages = (userId)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            const userMessages = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockMessages"].filter((msg)=>msg.senderId === userId || msg.receiverId === userId);
...
const sendMessage = (message)=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockMessages"].push(message);
            resolve(message);
        }, 500);
    });
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0238f38f._.js.map