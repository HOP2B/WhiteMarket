...
const MESSAGES_STORAGE_KEY = "white-market-messages";
...
// Initialize messages with localStorage data
let mockMessagesData = loadMessagesFromStorage();
const mockReviews = [
    {
        id: "1",
        gigId: "1",
...
const getMessages = async (userId)=>{
    // Use persisted mock data for development
    const userMessages = mockMessagesData.filter((msg)=>msg.senderId === userId || msg.receiverId === userId).map((msg)=>{
        const sender = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === msg.senderId);
        const receiver = __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$mockData$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["mockUsers"].find((u)=>u.id === msg.receiverId);
        return {
            ...msg,
            sender: sender ? {
                name: sender.name,
    ...
    return userMessages.sort((a, b)=>new Date(a.timestamp).getTime() - new Date(b.timestamp).getTime());
};
const sendMessage = async (message)=>{
    ...
    saveMessagesToStorage(mockMessagesData);
    return newMessage;
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1bf7c011._.js.map